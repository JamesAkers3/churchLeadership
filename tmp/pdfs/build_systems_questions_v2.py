"""Five-area review with preference and workload guardrails; preserves v1."""
...
OUTPUT = ROOT / 'output/pdf/is-this-still-serving-the-calling-v2.pdf'
...
def build():
    ...
    pdf.setTitle('Is This Still Serving the Calling? | v2')
    ...
    text(pdf, 'Review one ministry in an existing conversation. Use the spaces you need.',
    ...
    areas = [
        ...
        ('Staff', 'Are Staff growing and equipped to lead, with the time, authority, '
    ...
    bottom = text(pdf, 'Name harm honestly, even when others benefit. Consider this ministry\'s '
