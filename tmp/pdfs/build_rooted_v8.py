...
OUTPUT = ROOT / "output" / "pdf" / "rooted-flourishing-multiplying-life-v8.pdf"
...
def build():
    ...
    c.setTitle("Rooted. Flourishing. Multiplying Life.")
    c.setSubject("A Christ-centered botanical picture of rooted life, flourishing, fruit, and multiplication across changing seasons")
    ...
    c.drawString(31, 585, "ROOTED. FLOURISHING. MULTIPLYING LIFE.")
