"""Approved image-free layout; retain every word from the preserved v3 page."""
...
OUTPUT = ROOT / 'output/pdf/when-the-light-grows-dim-v4.pdf'
...
def build():
    ...
    pdf.setTitle('When the Light Grows Dim | v4')
    ...
    bottom = paragraph(pdf, 'MARK 6:30-32 / PARAPHRASE', bottom-7,
