"""Consistent relationship typography, preserving James' approved message."""
...
OUTPUT = ROOT / "output/pdf/christ-at-the-center-1-3-12-v6.pdf"
...
def build():
    ...
    pdf.setTitle("Who Are You Bringing With You? | Christ at the Center | v6")
    ...
    sections = [
        ...
        ("12", "Bring people close. Entrust real ministry.",
         "The disciples learned beside Jesus before He sent them together.",
    ...
    paragraph(
        ...
        "Human", 11, 12, INK, left, 62, width, floor=33,
    )
