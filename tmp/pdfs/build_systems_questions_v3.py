"""Five-area review with preference and workload guardrails; preserves v1/v2."""
...
OUTPUT = ROOT / 'output/pdf/is-this-still-serving-the-calling-v3.pdf'
...
def build():
    ...
    pdf.setTitle('Is This Still Serving the Calling? | v3')
