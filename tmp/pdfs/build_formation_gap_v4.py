"""Focused Scripture/application revision; leave all earlier PDFs untouched."""
...
OUTPUT = ROOT / "output/pdf/the-formation-gap-v4.pdf"
QUOTE = "“He appointed twelve that they might be with him and that he might send them out to preach”"
...
def build_pdf():
    ...
    pdf.setSubject("Shared ministry: exact Scripture and distinct practical application")
    ...
    quote_bottom = base.draw_paragraph(
        pdf, QUOTE,
        base.style("scripture", "Georgia-Bold", 16.5, 20.5, base.WHITE),
        margin + 25, 543, content_width - 50,
    )
    label_bottom = base.draw_paragraph(
        pdf, "MARK 3:14 / NIV",
        base.style("scripture-label", "Helvetica-Bold", 8.5, 11, base.SAGE),
        margin + 25, quote_bottom - 7, content_width - 50,
    )
    assert label_bottom >= 483, "Scripture panel needs more room."
