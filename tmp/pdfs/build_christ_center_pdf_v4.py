...
SUPPORT_OUTPUT = ROOT / "output/pdf/a-pastor-can-be-known-and-still-unsupported-v4.pdf"
...
def build_support_pdf() -> None:
    ...
    pdf.line(page_width / 2, 478, page_width / 2, 561)
    ...
    pdf.roundRect(margin, 345, content_width, 94, 12, fill=1, stroke=0)
    pdf.setFillColor(GOLD)
    pdf.rect(margin, 345, 6, 94, fill=1, stroke=0)
